...
document.addEventListener("DOMContentLoaded", () => {
     ...
     */
    //
    if (pagenow.includes('pmpro-membershiplevels') && hutko_param !== "undefined") {
        ...
        trialDescriptionText.innerText = hutko_param.trialDescriptionText;
    ...
    if (pagenow.includes('pmpro-paymentsettings')) {
        ...
        if (gatewaySelect != null && gatewaySelect.value === 'hutko' && typeof pmpro_changeGateway === "function") {
            pmpro_changeGateway('hutko');
        }
    }
});